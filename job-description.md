Title: Product Manager (ex-founder or ex-product engineer) - PostHog

URL Source: https://posthog.com/careers/product-manager-(ex-founder-or-ex-product-engineer)

Published Time: Wed, 18 Feb 2026 18:28:01 GMT

Product Manager (ex-founder or ex-product engineer) - PostHog
===============
...
*   Product Engineer Multiple teams  
*   AI Product Engineer Multiple teams  
*   AI Research Engineer PostHog AI Team  
*   Backend Engineer — Billing Billing Team  
*   ClickHouse Operations Engineer ClickHouse Team  
*   Mobile Engineer Client Libraries Team  
*   Product Manager (ex-founder or ex-product engineer)  
*   Software Engineer — AI-Enabled Product Autonomy Twig Team  
*   SRE- Clickhouse Team ClickHouse Team  
*   Technical Ex-Founder Multiple teams  

### Build the company

*   Finance Lead People & Ops Team  
*   Ops Manager People & Ops Team  
*   Talent Partner Talent Team  
*   Talent Sourcer Talent Team  

### Sell products

*   Developer Marketer Marketing Team  
*   Technical Account Manager Multiple teams  

### Work with customers

*   Technical Customer Success Manager Customer Success Team  
...
1.   Benchmark (United States - Alaska)$170,880
2.    Level modifier 1
3.    Step modifier 0.95 - 1.04

Salary$162,336 - $177,715+ significant equity
...
No data is sent to a third party. (Ursula von der Leyen would be so proud.) ![Image 22: Ursula von der Leyen, President of the European Commission](https://res.cloudinary.com/dmukukwp6/image/upload/c_scale,w_180/v1/posthog.com/src/components/EU/images/ursula)
